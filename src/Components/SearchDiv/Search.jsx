...
const Search = () => {
  return (
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      ...
      <button className='bg-blueColor p-5 px-10p h-full rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Search</button>
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        ...
        <div className="singleSearch flex items-center gap-2">
        <label htmlFor='time' className='text-[#808080] font-semibold'>Type:</label>
        <select name='' id='time' className='bg-white rounded-[3px] px-4 py-1'>
